...
/**
 * is_chain - this is testing if char in buffer is a chain delimeter
...
/**
 * probe_chain - continue chaining based on last status
...
void probe_chain(info_t *info, char *buf, size_t *p, size_t i, size_t len)
{
	size_t j = *p;
